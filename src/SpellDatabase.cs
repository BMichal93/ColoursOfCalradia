...
namespace ColoursOfCalradia
{
    ...
    public static class SpellDatabase
    {
        ...
        public static readonly IReadOnlyList<SpellEntry> All = new List<SpellEntry>
        {
            ...
            new SpellEntry { Name="Golden Word",       Combo="LULD", School=ColorSchool.Orange,
                Context=SpellContext.Map,
            ...
            new SpellEntry { Name="Whispered Ruin",   Combo="LUDD", School=ColorSchool.Yellow,
                Context=SpellContext.Map,
            ...
            new SpellEntry { Name="Scholar's Blueprint", Combo="LURU", School=ColorSchool.Blue,
                Context=SpellContext.Map,
            ...
            new SpellEntry { Name="Shared Feast",      Combo="ULLD", School=ColorSchool.Orange,
                Context=SpellContext.Map,
                ShortDesc="Food → morale.",
                Flavour="Consume one unit of food from your supplies to lift the spirit of those who march with you." },
            new SpellEntry { Name="Dread Whisper",     Combo="ULDD", School=ColorSchool.Yellow,
                Context=SpellContext.Map,
            ...
            new SpellEntry { Name="Verdant Hour",      Combo="ULLL", School=ColorSchool.Green,
                ...
                Flavour="The green works quietly. A harvest of grain appears, coaxed from the earth by patience and living magic." },
            new SpellEntry { Name="Scholar's Gaze",    Combo="ULRU", School=ColorSchool.Blue,
                Context=SpellContext.Map,
            ...
            new SpellEntry { Name="Grey Veil",         Combo="ULDU", School=ColorSchool.Purple,
                Context=SpellContext.Map,
                ShortDesc="Scatters nearby enemies; veils your next battle.",
                Flavour="The grey hides you — at a permanent price. Nearby enemies scatter. Fate adjusts itself in your favour for the battle ahead." },
        };
