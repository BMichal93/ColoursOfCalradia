    ...
    public static class SpellDatabase
    {
        ...
        public static readonly IReadOnlyList<SpellEntry> All = new List<SpellEntry>
        {
            ...
            new SpellEntry { Name="Verdant Surge",    Combo="UULL", School=ColorSchool.Green,
                ...
                Flavour="Life knows its own. The tide moves only toward your people — enemy and caster alike untouched, allies mended as the green passes through." },
            new SpellEntry { Name="Azure Arrest",     Combo="UURU", School=ColorSchool.Blue,
                Context=SpellContext.Mission,
                ShortDesc="Freezes and unseats all ahead.",
                Flavour="The Scholar's word stops the world mid-sentence. All before you simply halt. Riders find themselves seated on still air." },
            new SpellEntry { Name="Grey Harvest",     Combo="UUDU", School=ColorSchool.Purple,
                Context=SpellContext.Mission,
                ShortDesc="Kills 1–3 in the cone (scales with Vigor).",
                Flavour="The grey is not cruel. It is simply thorough. It moves through the cone, finds the weakest flames, and extinguishes them without ceremony." },
            ...
            new SpellEntry { Name="Arcane Sight",     Combo="URRU", School=ColorSchool.Blue,
                ...
                Flavour="The Scholar's eye opens across the whole of the map. Colour leaves a trace that time cannot fully erase — and the Sight follows it, naming who is near, what they carry, how far they roam." },
